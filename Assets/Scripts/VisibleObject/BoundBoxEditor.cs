...
namespace DimBoxes
{
    ...
    //         //Called whenever the inspector is drawn for this object.
            ...
            if (boundBox.mesh.vertices.Length > 1000) {
                EditorGUILayout.HelpBox("Lines for " + boundBox.mesh.vertices.Length + " vertices might take a long time to calculate. Consider using a simplified mesh.", MessageType.Warning);
            }
